package com.example.userservice.security.business.filter;

import com.example.userservice.security.business.filter.error.FilterError;
...
import com.example.userservice.security.business.service.JwtTokenProvider;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException
    {
        ...
        Optional<ExpiredJwt> token = expiredJwtRepo.findByJwt(jwt);

        if(userId != null && SecurityContextHolder.getContext().getAuthentication() == null && !token.isPresent())
        {
